...
<div class="ctr-form-process" style="min-height:550px; ">
	<div class="content-process" id="ctr-process" >
    	<form id="form-process" name="form-process" class="f-process" style="width:75%; margin:0 auto;">
			...
			<a href="certificate-detail.php?ide=<?=base64_encode($ide);?>&pr=<?=base64_encode('TRD');?>&type=<?=base64_encode('PRINT');?>&category=<?=base64_encode($category);?>" class="vc-popup">Ver Certificado</a>
...
?>
            ...
            <label class="fp-lbl">Cliente:</label>
