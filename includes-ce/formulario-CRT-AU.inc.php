<?php
function au_formulario_crt($link, $row, $rsDt, $url, $implant, $fac, $reason = '') {
            ...
            <table 
                ...
                <tr> 
                  <td style="width:100%; padding-bottom:4px; text-align:justify;">
                     ...
                     emisión de la Póliza, de acuerdo a Términos y Condicionespreviamente aprobados por Usted(es).
                     <br><br>
              ...
              <tr>
                  <td style="width: 50%; text-align: justify; padding: 5px; border-right: 1px solid #000;
                     ...
                     <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                      ...
                      <tr>
                        ...
                        <td style="width:98%; text-align:justify; font-weight:bold;">
                           PAGOS DE PRIMAS<br>
                      ...
                      <tr>
                        <td style="width:2%; font-weight:bold;" valign="top">3.</td>
                              ...
                              <tr>
                                ...
                                <td style="width:98%;">
                                    ...
                                    el Asegurado realice el pago anticipado del monto total de su operación crediticia
                                     adeudada al Contratante. Sin embargo, si la prima fue pagada al contado, la 
                                     póliza se mantendrá vigente hasta su finalización.
                                </td>
                              </tr>
                           </table>
                        </td>
                  ...
                  <td style="width: 50%; text-align: justify; padding: 5px; border-top: 1px solid #000;
                     ...
                     <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                       ...
                       <tr>
                         <td style="width:100%; text-align:justify; font-weight:bold;" colspan="2">
                            <u>En tal sentido al ser una póliza que no cuenta con renovación posterior al pago de la 
                            deuda con el contratante y siendo este el tomador de la póliza, Sudamericana no enviara 
                            aviso de vencimiento para la renovación o finalización de vigencia.</u>  
                         </td>
                       </tr>
                       <tr>
...
function get_date_format_crt($fecha){
	...
	return get_month_es_crt($month).' '.$day.' de '.$year;
}

function get_month_es_crt($month){
	switch ($month) {
		case 'January':
			return 'Enero';
			break;
