<?php
function au_formulario_uif($link, $row, $rsDt, $url, $implant, $fac, $reason = '') {
                  ...
                  <td style="width:40%;" align="right">
                     <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size: 100%;">
                        <tr>
                          ...
                          <td style="width:20%; text-align:center; border-top: 0px solid #000;
                           border-left: 1px solid #000; border-bottom: 1px solid #000; height:25px;
                           background:#d8d8d8; vertical-align:middle;">Año</td>
                        </tr>
                        <tr>
                          <td style="width:40%; text-align:center; border-left: 1px solid #000;
                           border-bottom: 1px solid #000; height:25px;"><?=$row['u_departamento'];?></td>
                          ...
                          <td style="width:20%; text-align:center; border-left: 1px solid #000;
                           border-bottom: 1px solid #000; height:25px;"><?=$anio;?></td>
                        </tr>
                     </table>
                  </td> 
                </tr>
            ...
            <table 
                  ...
                  <td style="width:52%; border-bottom: 1px solid #000; height:25px; text-align:left;">
                     <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                         <tr>
                          ...
                          vertical-align:middle;"><b>NACIONALIDAD:</b>&nbsp;<?=$row['pais'];?></td>
                  ...
                  <td style="width:100%; height:25px; border-bottom: 1px solid #000;" colspan="3">
                     <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                         <tr>
                           ...
                           background:#d8d8d8; vertical-align:middle;"><b>ESTADO CIVIL</b></td>
                           ...
                           <td style="width:34%; height:25px; border-left: 1px solid #000; text-align:left;">
                              <b>DIRECCION DOMICILIO:</b>&nbsp;<?=$row['direccion'];?>
                           </td>
                         </tr>
                      </table> 
                  </td>
                ...
                <tr>
                  <td style="width:100%; height:25px; border-bottom: 1px solid #000;" colspan="3">
                      <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                        <tr>
                          <td style="width:43%; text-align:left; height:25px;">
                            <b>PROFESION/ OCUPACION:</b> 
                          </td>
                ...
                <tr>
                  <td style="width:100%; height:25px; border-bottom: 1px solid #000;" colspan="3">
                     <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                         <tr>
                           <td style="width:13%; height:25px; text-align:left; 
