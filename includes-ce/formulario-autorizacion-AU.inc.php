            ...
            <table 
                ...
                <tr> 
                  <td style="width:100%; padding-bottom:4px; text-align:justify;">
                     ...
                     <br><br>
                     Asimismo, autorizo a realizar el débito automático para el pago de las cuotas que se generen de esta póliza de la cuenta corriente/ahorro Nº._____<?=$row['nro_cuenta_tomador'];?>_____ a nombre de ______<?=$row['tomador_nombre'];?>______
                     <br><br><br>
                     <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-size:100%;">
                         ...
                         <tr> 
                          ...
                          <td style="width:50%; border-bottom: 1px solid #333;">&nbsp;
                             <?=strtoupper(get_date_format_fat_au($row['fecha_emision']));?>
                          </td>
                          <td style="width:30%;"></td>  
                         </tr> 
                     </table>
